...
IP_ADDRESS = '10.239.128.59' # Replace with your IP address
PORT = 5001
...
class Server:
    def __init__(self):
        ...
        # Modify the CREATE TABLE statement to include the 'receiver' column
        c.execute('''CREATE TABLE IF NOT EXISTS messages
                     (sender TEXT, receiver TEXT, message TEXT, timestamp REAL)''')
        conn.commit()
        conn.close()
